...
- __Application__ refers to Duckov, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Duckov.
...
- By email: escape-from-duckov@outlook.com
